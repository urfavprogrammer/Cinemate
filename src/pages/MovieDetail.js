...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovies(){
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=7a05981f504f2c7d27fcfdb693a45b78`);
        ...
        <section className="flex justify-around flex-wrap py-5">
          ...
          <div className="flex items-center">
            ...
            <span className=" text-gray-900 dark:text-white">{movie.vote_count} reviews</span>
              ...
              <p className="my-4">
                <span className="mr-2 font-bold">Rutime:</span>
